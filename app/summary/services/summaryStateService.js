/**
 * @ngdoc service
 * @name SummaryApp.SummaryStateService
 * @description
 * # SummaryStateService
 * Service in the SummaryApp.
 */
class SummaryStateService {
	constructor ($rootScope, $log, Course, ScheduleTermState, SectionGroup, Section, Tag, Event, Activity, TeachingCall, TeachingCallReceipt, ActionTypes) {
		var self = this;
		return {
			_state: {},
				...
				switch (action.type) {
					case ActionTypes.INIT_STATE:
						...
						supportCallResponses.forEach(function(supportCallResponse) {
							supportCallResponse.dueDate = self.millisecondsToFullDate(supportCallResponse.dueDate);
						});
						return supportCallResponses;
					default:
						return supportCallResponses;
...
export default SummaryStateService;
