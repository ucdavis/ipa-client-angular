class ModalAddSupportCallCtrl {
	constructor ($scope, $rootScope, $uibModalInstance, SupportCallStatusActionCreators,
...
ModalAddSupportCallCtrl.$inject = ['$scope', '$rootScope','$uibModalInstance', 'SupportCallStatusActionCreators',
'supportCallMode', 'scheduleId', 'state', 'year', 'nextYear', 'termShortCode'];

export default ModalAddSupportCallCtrl;
