class ModalContactSupportCallCtrl {
	constructor ($scope, $rootScope, $uibModalInstance, SupportCallStatusActionCreators, supportCallMode, scheduleId, state, year, termShortCode, selectedParticipants) {
...
ModalContactSupportCallCtrl.$inject = ['$scope', '$rootScope', '$uibModalInstance', 'SupportCallStatusActionCreators', 'supportCallMode', 'scheduleId', 'state', 'year', 'termShortCode', 'selectedParticipants'];

export default ModalContactSupportCallCtrl;
