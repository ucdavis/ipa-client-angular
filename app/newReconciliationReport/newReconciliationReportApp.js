  ...
  syncActions: {
    ...
    list: {
      '291': {
        ...
        description:
          'Change ECS 032A section A01 (62294) Discussion days from M to W'
      }
    }
  },
  uiState: {}
...
const sectionsArray = sampleData.sections.ids.map(
  sectionId => sampleData.sections.list[sectionId]
);

ReactDOM.render(
  <DiffList sections={sectionsArray} />,
