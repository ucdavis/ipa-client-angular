 ...
 */
class ModalAddInstructorsCtrl {
	constructor ($scope, $rootScope, $uibModalInstance, scheduleYear, workgroupId, state, TermService) {
		this.$scope = $scope;
...
ModalAddInstructorsCtrl.$inject = ['$scope', '$rootScope', '$uibModalInstance', 'scheduleYear', 'workgroupId', 'state', 'TermService'];

export default ModalAddInstructorsCtrl;
