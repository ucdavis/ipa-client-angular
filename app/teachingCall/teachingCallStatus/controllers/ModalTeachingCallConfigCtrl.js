class ModalTeachingCallConfigCtrl {
	constructor ($scope, $rootScope, $uibModalInstance, scheduleYear, viewState, workgroupId, allTerms) {
		this.$scope = $scope;
...
ModalTeachingCallConfigCtrl.$inject = ['$scope', '$rootScope', '$uibModalInstance', 'scheduleYear', 'viewState', 'workgroupId', 'allTerms'];

export default ModalTeachingCallConfigCtrl;
