sharedApp.controller('IpaNavCtrl', this.IpaNavCtrl = function(
		$scope,
		$window,
		ngNotify,
		workgroupService,
	...
	$scope.setTitle = function() {
		$scope.navTitle = sharedService.navTitle();
	}
	sharedService.registerObserverCallback($scope.setTitle, true);
