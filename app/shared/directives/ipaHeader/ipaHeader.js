class ipaHeader {
	constructor ($window, $location, $rootScope, authService, $routeParams) {
		return {
			restrict: 'E', // Use this via an element selector <dss-modal></dss-modal>
			templateUrl: require('ipaHeader.html'), // directive html found here:
...
ipaHeader.$inject = ['$window', '$location', '$rootScope', 'AuthService', '$routeParams'];
