 ...
 */
teachingCallResponseReportApp.controller('TeachingCallResponseReportCtrl', ['$scope', '$rootScope', '$routeParams', 'Term', 'scheduleSummaryReportActionCreators', 'authService', 'scheduleSummaryReportService',
	this.TeachingCallResponseReportCtrl = function ($scope, $rootScope, $routeParams, Term, scheduleSummaryReportActionCreators, authService, scheduleSummaryReportService) {
...
TeachingCallResponseReportCtrl.getPayload = function (authService, $route, Term, scheduleSummaryReportActionCreators) {
