 ...
 * Debugger mode
 */
var debuggerEnabled = window.location.hostname === 'ipa.dss.ucdavis.edu' ? false : true;
var ipaRunningMode = window.location.hostname === 'ipa.dss.ucdavis.edu' ? 'production' : 'development';